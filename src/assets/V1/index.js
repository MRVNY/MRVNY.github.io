...
ucg = {
    ...
    "id": "ucg",
    "tags": "#Unity #PersonalProject #Ongoing",
...
floop = {
    ...
    "id": "floop",
    "tags": "#UnrealEngine #GameJam #C++ #Blueprint",
    ...
    "youtube": "https://www.youtube.com/embed/IJTClHkSyns?si=xCGll9J9PpUrhz_l",
...
spy = {
    "title": "SPY (2023)",
    "id": "spy",
    "tags": "#Unity #SeriousGame #SchoolProject",
...
chamois = {
    "title": "Chamois",
    "id": "chamois",
    "tags": "#Unity #SeriousGame #Internship",
...
const games = [zhuiyi, floop, spy, chamois, dice, quadravity, enjmin, splatable, zi, flop];

const qingyuan = {
    "title": "qingyuan.games",
    "id": "qingyuan",
    "tags": "#WebDevelopement #PersonalProject #Portfolio",
...
const metarl = {
    ...
    "id": "metarl",
    "tags": "#ReinforcementLearning #Tensorflow",
...
const web = {
    "title": "Birdy",
    "id": "web",
    "tags": "#Web #JavaScript #HTML #CSS #Node.js",
    "text1": "Project for the Web dev class - an ugly rip-off of Twitter.",
    "code": "https://github.com/MRVNY/Server"
}

//Dev entries
const devs = [qingyuan, justlmd, ecotopia, metarl, hcibook, hcigi, dedale, drone, web];

function onLoadGame() {
    var sidebar = document.getElementById("sidebar");
    var headertext = document.getElementById("header-text");

    if (window.innerWidth < window.innerHeight || window.innerWidth / window.innerHeight > 7 / 16) {
...
function onLoadDev() {
    ...
    for (i = 0; i < devs.length; i++) {
        ...
        a.className = "click";
        a.href = "#" + entry.id;
        // a.onclick = function () { document.getElementById(arg).scrollIntoView({ behavior: 'smooth' });};
        a.innerHTML = entry.title;
        li.appendChild(a);
        li.appendChild(document.createElement("br"));

        //tags
        var tags = document.createElement("tag");
        tags.className = "tag";
        ...
        //h1 
        block.appendChild(document.createElement("h1")).innerHTML = entry.title;

        //div.text
        var text = document.createElement("div");
        text.className = "text";
        text.innerHTML = entry.text1 + "<br>";
        if (entry.text2 != undefined) text.innerHTML += "<h6>" + entry.text2 + "</h6>";
        else text.innerHTML += "<br>";
        ...
        else if (entry.youtube != undefined) {
        ...
        //button_row
        var button_row = document.createElement("button_row");
        if (entry.play != undefined) {
            var a = document.createElement("a");
            a.href = entry.play;
            a.className = "click";
            a.innerHTML = "Play Game";
            button_row.appendChild(a);
        }
        ...
        if (entry.report != undefined) {
            ...
            a.href = entry.report;
            a.className = "click";
            a.innerHTML = "Read Report";
            button_row.appendChild(a);
        }
        block.appendChild(button_row);
